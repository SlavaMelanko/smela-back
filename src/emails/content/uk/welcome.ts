...
export const content: WelcomeEmailContent = {
  ...
  previewText:
    `Ласкаво просимо до ${config.company.name} — будь ласка, підтвердіть свою електронну пошту`,
  greeting: (firstName?: string) => `Привіт, ${firstName || 'дорогий користувач'} 👋`,
  body:
    'Ласкаво просимо! Будь ласка, підтвердьте свою електронну пошту, щоб розпочати:',
