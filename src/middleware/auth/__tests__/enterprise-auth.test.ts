...
import { enterpriseStrictAuthMiddleware } from '../index'
...
describe('Enterprise Authentication Middleware', () => {
  ...
  describe('Role Validation', () => {
    it('should allow Enterprise with Active status', async () => {
      ...
      app.get('/enterprise', c => c.json({ message: 'success' }))

      const res = await app.request('/enterprise', {
        headers: {
  ...
  describe('Status Validation', () => {
    it('should reject non-Active statuses', async () => {
      ...
      for (const status of nonActiveStatuses) {
        ...
        testApp.get('/enterprise', c => c.json({ message: 'success' }))

        const res = await testApp.request('/enterprise', {
          headers: {
